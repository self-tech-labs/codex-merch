...
export type CodexMerchProductFieldsFragment = Pick<
  StorefrontAPI.Product,
...
export type CodexMerchCatalogQueryVariables = StorefrontAPI.Exact<{
  query: StorefrontAPI.Scalars['String']['input'];
  first: StorefrontAPI.Scalars['Int']['input'];
}>;

export type CodexMerchCatalogQuery = {
  products: {
    nodes: Array<
      Pick<
        StorefrontAPI.Product,
...
export type CodexMerchProductQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
}>;

export type CodexMerchProductQuery = {
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  #graphql\n  fragment CodexMerchProductFields on Product {\n    id\n    handle\n    title\n    description\n    tags\n    featuredImage {\n      url\n      altText\n    }\n    variants(first: 1) {\n      nodes {\n        id\n        price {\n          amount\n          currencyCode\n        }\n      }\n    }\n  }\n\n  query CodexMerchCatalog($query: String!, $first: Int!) {\n    products(first: $first, query: $query) {\n      nodes {\n        ...CodexMerchProductFields\n      }\n    }\n  }\n': {
    return: CodexMerchCatalogQuery;
    variables: CodexMerchCatalogQueryVariables;
  };
  '#graphql\n  #graphql\n  fragment CodexMerchProductFields on Product {\n    id\n    handle\n    title\n    description\n    tags\n    featuredImage {\n      url\n      altText\n    }\n    variants(first: 1) {\n      nodes {\n        id\n        price {\n          amount\n          currencyCode\n        }\n      }\n    }\n  }\n\n  query CodexMerchProduct($handle: String!) {\n    product(handle: $handle) {\n      ...CodexMerchProductFields\n    }\n  }\n': {
    return: CodexMerchProductQuery;
    variables: CodexMerchProductQueryVariables;
  };
